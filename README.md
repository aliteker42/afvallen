...
| **Ayarlar** | Profil, hedefler, koç tonu, API anahtarı, yedekleme |
...
Bu uygulama bir takip ve alışkanlık aracı. Kalori tahminleri — özellikle fotoğraftan gelenler — yaklaşıktır. Ciddi kilo verme sürecinde, özellikle mevcut bir sağlık sorunu veya ilaç kullanımı varsa, bir doktora danışmakta fayda var.
